...
extern void psormqr_( char *side, char *trans, int *m, int *n, int *k, float *A, int *ia, int *ja, int *desca, float *tau, float *C, int *ic, int *jc, int *descc, float *work, int *lwork, int *info );
//
//------------------double precision---------------------------
